...
Achtung: Normalerweise bevorzugen Wärmepumpe längere Laufzeiten am Stück, 
teilweise ist auch die Garantie an eine Durchschnittslaufzeit gekoppelt. 
Prüft in solchen Fällen den Einsatz der Parameter "disable" und "guardduration".
...
# Die bekannten Parameter von den Wallboxen können ergänzt werden, beispielsweise
    ...
    disable: #
      threshold: 200
      delay: 20m
    guardduration: 30m #Gut für die Lebensdauer der Wärmepumpe
